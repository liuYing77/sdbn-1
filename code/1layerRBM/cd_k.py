...
if start > 0 :
    [a,b,W] = np.load('/home/liuq/apt/2ndYear/sDBN/cdk/%04d_b%04d_epoc%05d_%s.npy'%(train_num, batch_size, start, alg))
else:
    hiden_num = 500
...
np.save('/home/liuq/apt/2ndYear/sDBN/cdk/%04d_b%04d_epoc%05d_%s.npy'%(train_num, batch_size, start+epoc, alg),[a,b,W])
