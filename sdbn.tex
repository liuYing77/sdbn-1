...
\begin{document}
	...
	\title{On-line Training of Spiking Deep Belief Network}
	\author{
	Qian~Liu
	\thanks{
...
%			\EndFor
	...
	\begin{figure}[hbt]
		\centering
		\includegraphics[width=0.2\textwidth]{img/gibbs.png}
...
If we look at the measured results in Figure~\ref{Fig:error}, it is not surprise to see there is no obvious difference on the reconstruction error among $CD_1$, $CD_2$ and $CD_{1000}$.
	...
	\begin{figure}[hbt]
		\centering
		\includegraphics[width=0.2\textwidth]{img/test.pdf}
...
\begin{figure}[hbt]
  \centering
  \subfloat[Reconstruction error over training images, plotted only for the first $8,000$ searching steps.]{
 ...
 \subfloat[Reconstruction error over testing images, plotted only for the first $8,000$ searching steps.]{
...
\begin{figure}[hbt]
  \centering
  \subfloat[Original distribution of the training data.]{
    \includegraphics[width=0.2\textwidth]{img/train_dist.pdf}
  }
  \subfloat[$5,420$ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/cd1_1.pdf}
  }
  \subfloat[$ 27,100 $ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/cd1_51.pdf}
  }
  \subfloat[$ 48,780 $ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/cd1_91.pdf}
  }
  \subfloat[Searching path of para $\mu$ and $\sigma$.]{
    \includegraphics[width=0.2\textwidth]{img/cd1_para.pdf}
  }\\
  \subfloat[$600$ steps of K times $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/kcd_100.pdf}
  }
  \subfloat[$5,400$ steps of K times $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/kcd_900.pdf}
  }
  \subfloat[$ 22,764 $ steps of K times $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/kcd_3794.pdf}
  }
  \subfloat[$ 48,780 $ steps of K times $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/kcd_18428.pdf}
  }
  \subfloat[Searching path of para $\mu$ and $\sigma$.]{
    \includegraphics[width=0.2\textwidth]{img/kcd_long_para.pdf}
  }\\
  \subfloat[$600$ steps of$CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/cdk_100.pdf}
  }
  \subfloat[$3,000$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/cdk_500.pdf}
  }
  \subfloat[$3,600$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/cdk_600.pdf}
  }
  \subfloat[$5,400 $ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/cdk_900.pdf}
  }
  \subfloat[Searching path of para $\mu$ and $\sigma$.]{
    \includegraphics[width=0.2\textwidth]{img/cdk_para.pdf}
  }
  \caption{
...
\begin{figure}[hbt]
				\centering
				\includegraphics[width=0.3\textwidth]{img/ReconError.pdf}
...
\begin{figure}[hbt]
  \centering
  \subfloat[Original normal distribution of the training data.]{
    \includegraphics[width=0.2\textwidth]{img/train_data_v.pdf}
  }\\
  \subfloat[$1,000$ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cd1_1000.pdf}
  }
  \subfloat[$3,000$ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cd1_3000.pdf}
  }
  \subfloat[$5,000$ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cd1_5000.pdf}
  }
  \subfloat[$7,000$ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cd1_7000.pdf}
  }
  \subfloat[$9,000$ steps of $CD_1$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cd1_9000.pdf}
  }\\
  \subfloat[$1,000$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cdk_1000.pdf}
  }
  \subfloat[$3,000$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cdk_3000.pdf}
  }
  \subfloat[$5,000$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cdk_5000.pdf}
  }
  \subfloat[$7,000$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cdk_7000.pdf}
  }
  \subfloat[$9,000$ steps of $CD_{1000}$.]{
    \includegraphics[width=0.2\textwidth]{img/gibbs_cdk_9000.pdf}
  }\\
  \caption{
...
%	  The same applies to the recognition pass}.
	...
	\begin{figure}[hbt]
	  \centering
	  \subfloat[A DBN contains undirected RBM on the top and directed belief net on the lower layers~\cite{hinton2006fast}.]{
	    \includegraphics[width=0.42\textwidth]{img/dbn.jpg}
	  }
	  \subfloat[Deep Belief Network framework.]{
	      \includegraphics[width=0.42\textwidth]{img/dis.jpg}
	  }
	  \caption{
...
%			\State Initialisation $\mathbf{x}_0 = [x_0(1),x_0(2),...,x_0(M)]$,  \Comment{Random initialise $\mathbf{x}_0$}
	...
	The only difference or addition is the label layer (10 neurons) locating on the top of the network, see Figure~\ref{Fig:case}.
		\begin{figure}[hbt]
				\centering
				\includegraphics[width=0.4\textwidth]{img/DBN.pdf}
...
%	The recognition and error rates are: epoc 1 (65.5\%, 14.11\%) and epoc 40 (70.51\%, 5.47\%). 
		\begin{figure}[hbt]
				\centering
				\includegraphics[width=0.3\textwidth]{img/MNISTerror.pdf}
...
\section{Spiking DBN}
\subsection{Rectified Linear Units(ReLU)~\cite{nair2010rectified}}
	...
	The input vector in a ReLU based RBM does no longer have to be binary, so it can be a float~\textcolor{red}{fig?}.
	...
	\begin{figure}[hbt]
							\centering
							\includegraphics[width=0.4\textwidth]{img/relu.pdf}
							\caption{The DBN architecture.} 
...
\subsection{Training ReLU DBN}
	...
	\begin{figure}[hbt]
	  \centering
	  \subfloat[epoc 1.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc1.png}
	  }
	  \subfloat[epoc 2.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc2.png}
	  }
	  \subfloat[epoc 3.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc3.png}
	  }
	  \subfloat[epoc 4.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc4.png}
	  }
	  \subfloat[epoc 5.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc5.png}
	  }\\
	  \subfloat[epoc 6.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc6.png}
	  }
	  \subfloat[epoc 7.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc7.png}
	  }
	  \subfloat[epoc 8.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc8.png}
	  }
	  \subfloat[epoc 9.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc9.png}
	  }
	  \subfloat[epoc 10.]{
	    \includegraphics[width=0.2\textwidth]{img/b10_epoc10.png}
	  }\\
	  \caption{
	  Distribution of the Gibbs samples.
	  }
...
\subsection{Mapping to spiking DBN}
	\subsubsection{Single LIF neuron activity}
		\begin{itemize}
			\item Stable current
			\item Poissonian spike trains with same synaptic current
			\item Linear approximation
		\end{itemize}
		\begin{figure}[hbt]
			\centering
			\includegraphics[width=0.4\textwidth]{img/20trail.pdf}
			\caption{Out put firing rate against input current.} 
			\label{Fig:rate_lif}
		\end{figure}
		
	\subsubsection{Scaling}
		With trained DBN using ReLU, to scale the weights to spiking DBN is the first task to concern.
		We can see the linear transformation with Poissonian spikes only occur in a region of current input.
		So for a single layer of RBM, we split the recurrent connections into separate connections of three layer: visible layer, hidden layer and output layer.
		First of all, we map the sum of weighted input (the total synaptic current) into a region where the average firing rate is about 30 Hz.
		And then with the firing rate out of the hidden layer, we do the same to the output neurons, see Figure~\ref{Fig:relu_rbm}.
		\begin{figure}[hbt]
					\centering
					\includegraphics[width=0.4\textwidth]{img/drawing.pdf}
					\caption{Out put firing rate of the output layer and the hidden layer using original DBN, spiking DBN and the linear approximation.} 
					\label{Fig:relu_rbm}
		\end{figure}
	\subsubsection{Problem}
		We see the slightly higher activity in spiking DBN than the linear approximation.
		Thus we plot the real transfer function with the real spiking data, see~\ref{Fig:real_map}.
		The main cause is the noisy input of many Poissonian spiking sources.
		Thus a test is tempted to show how noise plays a role in the transformation function, Figure~\ref{Fig:noise_map}.
			\begin{figure}[hbt]
						\centering
						\includegraphics[width=0.4\textwidth]{img/real_map.pdf}
						\caption{Real LIF neuron transformation function using the MNIST single image.} 
						\label{Fig:real_map}
			\end{figure}
			\begin{figure}[hbt]
						\centering
						\includegraphics[width=0.4\textwidth]{img/noise.pdf}
						\caption{Noisy current influences the firing rate.} 
						\label{Fig:noise_map}
			\end{figure}
		
		In result, noise is influential in the transformation function which means the same LIF neuron performs differently with various data.
		This data-dependent mapping will be not the same with the original DBN. 
	\subsubsection{Mapped DBN}
		By applying the same scaling technique for every layer of the network.
		We have tested the recognition rate for this spiking DBN.
		It reaches 89.85\% on correct recognition, 8.72\% on wrong classification and 1.43\% on unrecognised.
	\subsubsection{Mapped CNN}
		\begin{itemize}
			\item Sigmoid
			\item ReLU (currently working on Mapping)
			\item Softmax (new form)
			\item Problem: bias on softmax; better mapping methods?
		\end{itemize}
\subsection{Discussion}
	\begin{itemize}
		\item The maths explaining ReLU.	
		\item why no bias
		\item why fine tuning does not work
		\item data-dependent mapping
		\item the correct way the assess the mapping both for RBM and DBN.
	\end{itemize}

\section{STDP on Spiking RBM~\cite{neftci2013event}}
